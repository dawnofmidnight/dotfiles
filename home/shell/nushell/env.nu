...
def create_left_prompt [] {
    ...
    let host_part = $"(ansi purple)[(ansi blue)(whoami)(ansi purple)@(ansi blue)(hostname)(ansi purple)] (ansi reset)"
    let path_part = $"(ansi red)($dir)" | str replace --all (char path_sep) $"(ansi purple)(char path_sep)(ansi red)"
    $host_part | append $path_part
}

def create_right_prompt [] {
    # create a right prompt in magenta with green separators
    let time_segment = ([
        (ansi reset)
        (ansi magenta)
